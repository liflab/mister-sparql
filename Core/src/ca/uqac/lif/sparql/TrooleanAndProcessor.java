...
public class TrooleanAndProcessor extends UniformProcessor
{
	...
	public TrooleanAndProcessor(Processor left, Processor right)
	{
		super(1, 1);
		m_left = left;
		m_right = right;
	...
	protected boolean compute(Object[] inputs, Object[] outputs)
	{
		if (m_verdict == Value.INCONCLUSIVE)
		{
			...
			m_verdict = Troolean.and(left, right);
		}
		outputs[0] = m_verdict;
		return true;
	}
	...
	@Override
	public TrooleanAndProcessor duplicate(boolean with_state)
	{
		TrooleanAndProcessor p = new TrooleanAndProcessor(m_left.duplicate(with_state), m_right.duplicate(with_state));
		return p;
	}
}
